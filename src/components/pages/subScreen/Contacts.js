                ...
                <View style={{ width:'100%', justifyContent:'center', alignItems:'center',  padding:5, marginTop:10}}>
                   <View style={{
                        ...
                        style={{width:60, height:60, borderRadius:20}}
                         ...
                         style={{flex:1, borderWidth:1, borderColor:COLORS.secondary, justifyContent:'center', alignItems:'center', height:40, borderRadius:10}}>
                         <View style={{ justifyContent:'center', alignItems:'flex-end'}} >
                             <Text style={{color:COLORS.secondary}}>Invite</Text>
                         </View>
                         </TouchableOpacity>
                   </View>
                </View>

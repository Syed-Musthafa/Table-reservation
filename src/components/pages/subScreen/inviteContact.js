...
const inviteContact = ({ navigation }) => {
            ...
            <View style={{ width: '100%', }}>
                <View style={{ padding: SIZES.padding2, marginTop: 50 }}>
                    ...
                    <View style={{ marginTop: 30 }}>
                        <Text style={{ color: '#ffffff', fontSize: 45, fontWeight: 'bold' }}>Contacts</Text>
        ...
        return (
            <View>
                ...
                <View style={{ padding: 15 }}>
                    <View style={{ width: '100%', height: 300, backgroundColor: "#fff", borderRadius: 10, ...styles.shadow, padding: 20 }}>
                        <View style={{ flexDirection:'row', borderWidth: 1, padding: 10, borderRadius: 10, borderColor: COLORS.gray1 }}>
                            <Text>To:</Text>
                            <TextInput
                ...
                <View style={{flex:1,  justifyContent:'center', alignItems:'flex-end', padding:20, marginTop:30,}}>
                    <TouchableOpacity style={{borderColor:COLORS.secondary, borderWidth:1, width:100, height:40, justifyContent:'center', alignItems:'center',borderRadius:10}}>
                        <Text style={{ color:COLORS.secondary,}}>send</Text>
                    </TouchableOpacity>
                </View>
            </View>
        )
    ...
    return (
        <View style={styles.container}>
            <View style={{ flex: 1, backgroundColor: COLORS.secondary, borderBottomLeftRadius: 20, borderBottomRightRadius: 20 }}>
                {renderHeader()}
            </View>
